 ...
 * @author Dan Klein
 */
public class KneserNeyTrigramLanguageModel implements LanguageModel {
   ...
   */
  public KneserNeyTrigramLanguageModel() {
   ...
   */
  public KneserNeyTrigramLanguageModel(Collection<List<String>> sentences) {
    this();
    train(sentences);
  }
