 ...
 * @author Dan Klein
 */
public class KatzBackoffBigramLanguageModel implements LanguageModel {
   ...
   */
  public KatzBackoffBigramLanguageModel() {
   ...
   */
  public KatzBackoffBigramLanguageModel(Collection<List<String>> sentences) {
    this();
    train(sentences);
  }
